...
public class SocksSocket extends Socket {
     ...
     * implementation factory's <code>createSocketImpl</code> method is called
     ...
     * @exception IOException if an I/O error occurs when setting the socket
     * factory.
     */
     ...
     * size used by the platform for output on the this Socket.
     *
     ...
     * size used by the platform for input on the this Socket.
     *
    ...
    /**
     * Enable/disable SO_LINGER with the specified linger time in seconds. If
     ...
     * of time. If the timeout expires, a <B>java.io.InterruptedIOException</B>
     ...
     * for the size to use to allocate set the underlying network I/O buffers.
     *
     * <p>
     ...
     * the buffers were set to should call
    ...
    /**
     * Some important optional parameters for SOCKS4 and SOCKS5
     */
    /**
    ...
    /**
     * Use USERID,PASSWD or PASSWORD to set password for the specific SOCKS
     * proxy serer. For SOCKS4A, USERID mean a password
     */
    ...
    /**
     * Use VERSION to set the appropriate SOCKS version for the specific SOCKS
     * proxy serer. Value:4 or 5
     */
