 ...
 * <DD>[1] <A HREF="http://www.socks.nec.com/protocol/socks4.protocol">SOCKS 4
 * Protocol</A><BR>
 * <DD>[2] <A HREF="http://www.socks.nec.com/protocol/socks4a.protocol">SOCKS
 * 4A: A Simple Extension to SOCKS 4 Protocol</A><BR>
 * <DD>[3] <A HREF="//http://www.socks.nec.com/rfc/rfc1928.txt">RFC1928 SOCKS
 * Protocol Version 5</A><BR>
 * <DD>[4] <A HREF="//http://www.socks.nec.com/rfc/rfc1929.txt">RFC1929
 * Username/Password Authentication for SOCKS V5</A></DL></DD>
 * <DD>[5]
 * <A HREF="//http://www.socks.nec.com/draft/draft-ietf-aft-socks-pro-v5-04.txt">SOCKS
 * Protocol Version 5 (22 Feb 1999)</A></DL></DD>
 */
class SocksSocketImpl extends SocketImpl implements SocksSocketConstants {
 ...
 /*
    ...
    /**
     * Creates either a stream or a datagram socket. Creates a socket with a
     * boolean that specifies whether this is a stream socket (true) or an
     * unconnected UDP socket (false).
     *
     * @param	stream if <code>true</code>, create a stream socket; otherwise,
    ...
    /**
     * Connects this stream or datagram socket to the specified port number flag
     * the specified host.
     *
...
//						remoteBoundPort=tempBoundPort;
     ...
     * request to connect) to the <code>count</code> argument. If a connection
     ...
     * will return the paramter's value, else it will return
     ...
     * error to pass something that isn't of the expected type:
     * <BR><PRE>
     * SocketImpl s;
     * ...
     ...
     * </PRE> If the requested option is binary, it can be set using this method
     * by a java.lang.Boolean:
     * <BR><PRE>
     ...
     * </PRE>
     * <BR>
     * For an option that requires a particular parameter, setting its value to
     * anything other than
